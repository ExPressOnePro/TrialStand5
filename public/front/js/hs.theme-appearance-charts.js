...
HSCore.components.HSChartJS.addTheme('ecommerce-overview.blade.php-1', 'dark', {
  data: {
    datasets: [{
      borderColor: window.hs_config.themeAppearance.styles.colors.primary,
...
HSCore.components.HSChartJS.addTheme('ecommerce-overview.blade.php-2', 'dark', {
  data: {
    datasets: [{
      borderColor: window.hs_config.themeAppearance.styles.colors.primary,
      hoverBorderColor: window.hs_config.themeAppearance.styles.colors.primary,
...
HSCore.components.HSChartJS.addTheme('ecommerce-overview.blade.php-3', 'dark', {
  data: {
    datasets: [{
      borderColor: window.hs_config.themeAppearance.styles.colors.primary,
      hoverBorderColor: window.hs_config.themeAppearance.styles.colors.primary,
...
HSCore.components.HSChartJS.addTheme('ecommerce-overview.blade.php-4', 'dark', {
  data: {
    datasets: [{
      borderColor: window.hs_config.themeAppearance.styles.colors.primary,
      hoverBorderColor: window.hs_config.themeAppearance.styles.colors.primary,
