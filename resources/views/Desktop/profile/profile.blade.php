                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-left">
                                                    ...
                                                    <form>
                                                        <div class="row">
                                                            <div class="col-md-12 form-group mb-3">
                                                                ...
                                                                <input class="form-control" type="text" id="brief_information">
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                                            ...
                                            <div class="card mb-4">
                                                <h4 class="card-header text-left text-16">Информация</h4>

                                                <a class="list-group-item list-group-item-action list-group-item-secondary" href="{{ route('profileEdit', [ 'id' => $user->id]) }}">Личные данные</a>
                                                <a class="list-group-item list-group-item-action list-group-item-secondary" href="#">Безопасность</a>
                                                <a class="list-group-item list-group-item-action list-group-item-secondary" href="#">Профиль</a>
                                                <a class="list-group-item list-group-item-action list-group-item-secondary" href="#">Контакты</a>
                                            </div>
