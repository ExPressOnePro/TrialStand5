                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    @if (isset($user->info) && $decodedInfo = json_decode($user->info, true))
                                        ...
                                        @endif
                                    @endif
                                    <button type="button" class="btn btn-white ms-2" data-bs-toggle="modal" data-bs-target="#editUserModal{{$user->id}}">
                                        <i class="fa-solid fa-gear"></i>
                                    </button>
                                    @include('Modules.congregation.components.editUserModal')
                                </div>
                            </div>
                        </div>
                    </div>
