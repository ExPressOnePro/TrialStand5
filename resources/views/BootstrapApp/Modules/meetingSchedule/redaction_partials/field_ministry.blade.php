                    ...
                    <div class="row mb-2 d-flex justify-content-between" data-key="{{ $key }}">
                        ...
                        <div class="col-md-3">
                            <div class="form-floating mb-2">
                                ...
                                <label for="field_ministry_value_2_{{ $key }}">Помощник:</label>
                            </div>
                        </div>
                        <div class="col-md-3">
        ...
        function addFieldMinistry() {
            ...
            <div class="col-md-3">
                <div class="form-floating mb-2">
                    ...
                    <label for="field_ministry_value_${nextFieldMinistryKey}">Ведущий:</label>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-floating mb-2">
                    ...
                    <label for="field_ministry_value_2_${nextFieldMinistryKey}">Помощник:</label>
                </div>
            </div>
            <div class="col-md-3">
                <button type="button" class="col btn btn-outline-danger" onclick="removeFieldMinistry(this)">Удалить</button>
