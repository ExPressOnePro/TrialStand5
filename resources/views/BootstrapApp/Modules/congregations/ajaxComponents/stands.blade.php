                ...
                <div class="col mb-3 mb-lg-3">
                    <div class="card border-left-empty rounded-3 text-decoration-none shadow">
                        ...
                        @endif"
                            ...
                            @can('stand.settings')
                                <div class="dropdown">
                                    <button type="button" class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-5" id="projectsListDropdown3" data-bs-toggle="dropdown" aria-expanded="false">
