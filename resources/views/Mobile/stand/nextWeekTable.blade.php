                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="NewRecordStand1" method="post" action="{{ route('NewRecordStand1') }}">
                            @csrf
                            <input type="hidden" name="Valuetime" id="Valuetime">
                            <input type="hidden" name="Valueday" id="Valueday">
                            <input type="hidden" name="Valuegwe" id="Valuegwe">
                            <input type="hidden" name="Valuestand_template_id" id="Valuestand_template_id">

                            <p class="text-20 text-success text-center font-weight-bold line-height-1 mb-5">
        ...
        <script>
            $(document).ready(function() {
                $('.create_record1').click(function(event) {
                    ...
                    $('#stand_template_id').text(id);
                    $('#time').text(time);
                    $('#gwe').text(gwe);
                    $('#day').text(day);

                    $('#Valuestand_template_id').val(id);
                    $('#Valuetime').val(time);
                    $('#Valuegwe').val(gwe);
                    $('#Valueday').val(day);
