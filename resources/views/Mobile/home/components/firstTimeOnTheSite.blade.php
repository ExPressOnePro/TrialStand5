<div class="row justify-content-center">
    <div class="col-lg-4 mb-2 mb-lg-2 mx-auto">
            ...
            <div class="accordion-body">
                <div class="d-sm-flex">
                    ...
                    <div class="flex-grow-1 ms-sm-4 text-center">
                        <dd>{{__('text.В видеоролике ниже мы покажем, как пользоваться нашим обновленным сайтом.')}}</dd>
                        <dd>{{__('text.Не волнуйтесь, если вы чувствуете себя не очень опытным пользователем, мы сделали интерфейс максимально простым и удобным.')}}</dd>
                        <dd>{{__('text.Давайте начнем с самого начала и шаг за шагом разберемся, как пользоваться нашим сайтом.')}}</dd>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col">
